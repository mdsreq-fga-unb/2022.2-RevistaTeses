...
const LoginCadastro = () => {
  ...
  const handleLogin = async () => {
    await api
      .post("/auth/login", { email: emailLog, password: passwordLog })
      .then(function (res) {
        setInvalid("");
  ...
  function handleRegister() {
    api
      .post("/user/register", { name: name, email: email, password: password })
      .then(async (res) => {
        await api
        ...
        <div className="abaFormularios">
          ...
          <section className="deslizante esconde" id="deslizanteCadastro">
            ...
            <span className="subtitulo">
              Insira algumas informações e comece <br></br> a sua jornada
              conosco!
            </span>
            <button className="botaoDeslizante" id="deslizaCadastro">
              {" "}
              Já tenho conta!
            </button>
          </section>
          ...
          <section className="deslizante" id="deslizanteLogin">
            ...
            <span className="subtitulo">
              Mantenha-se conectado fazendo login <br></br> com as suas
              informações!
            </span>
            <button className="botaoDeslizante" id="deslizaLogin">
